...
const QString Affine::alphabetRussian = "абвгдеёжзийклмнопрстуфхцчшщъыьэюя";
const QString Affine::alphabetSortedByFrequencyRussian = "оеаинтсрвлкмдпуяыьгзбчйхжшюцщэфёъ";
const QString Affine::englishLanguage = "english";
const QString Affine::russianLanguage = "russian";
const int Affine::lenghtAlphabetEnglish = alphabetEnglish.length(); // 26
const int Affine::lenghtAlphabetRussian = alphabetRussian.length(); // 33
const qreal Affine::coincidenceIndexEnglish = 0.0667;
const qreal Affine::coincidenceIndexRussian = 0.0553;
const QList<QString> Affine::mostFrequentBigramsEnglish = (QList<QString>() << "th" << "he" << "in" << "er" << "an" << "re" << "es" << "on" << "st" << "nt" << "en" << "at");
const QList<QString> Affine::mostFrequentBigramsRussian = (QList<QString>() << "ст" << "ен" << "ов" << "но" << "ни" << "на" << "ра" << "ко" << "то" << "ро" << "ан" << "ос");
const QList<QString> Affine::prohibitedBigramsEnglish = (QList<QString>() << "bq" << "cx" << "gx" << "jq" << "jv" << "kx" << "qv" << "qx" << "qz" << "vq" << "xz" << "zq" << "zx");
const QList<QString> Affine::prohibitedBigramsRussian = (QList<QString>() << "оъ" << "оы" << "оь" << "еъ" << "еы" << "еь" << "аъ" << "аы" << "аь" << "иъ" << "иы" << "иь" << "уъ" << "уы" << "уь" << "яъ" << "яы" << "яь" << "юъ" << "юы" << "юь" << "эъ" << "эы" << "эь" << "йъ" << "йы" << "йь" << "ёъ" << "ёы" << "ёь" << "ыъ" << "ыы" << "ыь" << "ьъ" << "ьы" << "ьь" << "ъъ" << "ъы" << "ъь");
...
QList<QPair<int, int> > Affine::findKeys()
{
    ...
    qSort(bigramsFrequency.begin(), bigramsFrequency.end(), QPairSecondComparer());
