...
const QString Vizhener::alphabetUkrainian = "абвгґдеєжзиіїйклмнопрстуфхцчшщьюя";
const QString Vizhener::alphabetSortedByFrequencyUkrainian = "оаеинтрсвлкмдупяьзбгчйхжцїшщфєґ";
const QString Vizhener::englishLanguage = "english";
const QString Vizhener::ukrainianLanguage = "ukrainian";
const int Vizhener::lenghtAlphabetEnglish = alphabetEnglish.length(); // 26
const int Vizhener::lenghtAlphabetUkrainian = alphabetUkrainian.length(); // 33
const qreal Vizhener::coincidenceIndexEnglish = 0.0644;
const qreal Vizhener::coincidenceIndexUkrainian = 0.0576;
const QList<QString> Vizhener::mostFrequentBigramsEnglish = (QList<QString>() << "th" << "he" << "in" << "er" << "an" << "re" << "es" << "on" << "st" << "nt" << "en" << "at");
const QList<QString> Vizhener::mostFrequentBigramsUkrainian = (QList<QString>() << "на" << "но" << "ко" << "ра" << "по" << "ні" << "ти" << "ро" << "ст" << "ен" << "ан" << "то");
const QList<QString> Vizhener::prohibitedBigramsEnglish = (QList<QString>() << "bq" << "cx" << "gx" << "jq" << "jv" << "kx" << "qv" << "qx" << "qz" << "vq" << "xz" << "zq" << "zx");
const QList<QString> Vizhener::prohibitedBigramsUkrainian = (QList<QString>() << "аь" << "оь" << "уь" << "еь" << "иь" << "іь" << "їь" << "юь" << "яь" << "єь" << "ьь" << "йь");
...
{
    int lenghtText = m_text.length();
    constexpr int minLenghtKey = 1;
    constexpr int maxLenghtKey = 5;
    ...
    for(int lenghtKey = minLenghtKey; lenghtKey <= maxLenghtKey; ++lenghtKey)
    {
        ...
        if(std::fabs(coincidenceIndex - coincidenceIndexArray[lenghtKey]) < std::fabs(coincidenceIndex - coincidenceIndexArray[shortLenghtKey]))
...
{
    int lenghtText = m_text.length();
    constexpr int minLenghtKey = 6;
    constexpr int maxLenghtKey = 22;
